...
class HolidaysHolder {
    ...
    private static let dateToHoliday2026: [Int: Holiday] = Dictionary ([

        "1.1": Holiday(type: .Celebration, name: "Пресвятая Богородица Дева Мария"),
        "1.6": Holiday(type: .Celebration, name: "Богоявление"),
        "1.11": Holiday(type: .Holiday, name: "Крещение Господне"),
        "2.2": Holiday(type: .Holiday, name: "Сретение Господне"),
        "2.18": Holiday(type: .Holiday, name: "Пепельная Среда"),
        ...
        "3.29": Holiday(type: .Celebration, name: "Вербное Воскресенье"),
        "4.5": Holiday(type: .Celebration, name: "Пасха. Светлое Христово Воскресение"),
        "4.25": Holiday(type: .Holiday, name: "Св. Марк, Евангелист"),
        "4.29": Holiday(type: .Holiday, name: "Св. Екатерина Сиенская, дева и Учитель Церкви, покровительница Европы"),
        "5.14": Holiday(type: .Celebration, name: "Вознесение Господне"),
        "5.24": Holiday(type: .Celebration, name: "Сошествие Святого Духа. Пятидесятница"),
        "5.31": Holiday(type: .Celebration, name: "Персвятая Троица"),
        "6.7": Holiday(type: .Celebration, name: "Пресвятые Тело и Кровь Христа"),
        "6.12": Holiday(type: .Celebration, name: "Святейшее Сердце Иисуса"),
        ...
        "12.28": Holiday(type: .Holiday, name: "Свв. Невинные младенцы Вифлеемские, мученики"),
    ].map { (HolidaysHolder.strToOrdinal(str: $0, year: 2026), $1)    })
